...
(function () {
    ...
    function updateNavigationPanel(
        ...
        /*
         * The navigation panel is optional.
         *
         * If it is not present in the HTML,
         * the rest of the cockpit continues normally.
         */
        ...
        /*
         * Simulation-only navigation awareness.
         *
         * This function does NOT connect to:
         *
         * - GPS
         * - gyro
         * - radar
        ...
        /*
         * Preserve the existing visual panel.
         *
         * We only create one small information element
         * beneath the existing status card.
         */
    ...
    function updateCockpitFromSimulation(
        ...
        /*
         * Navigation / sensor awareness is updated
         * from the SAME deterministic simulation result.
         */
    ...
    function resetDPCockpit() {
        ...
        /*
         * Reset simulated navigation / sensor awareness.
         */
    ...
    function initializeDPCockpit() {
        ...
        /*
         * Initialise simulated navigation / sensor
         * awareness without changing the screen.
         */

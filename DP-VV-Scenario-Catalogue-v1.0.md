...
The DP Resilience V&V Research Cockpit uses the existing scenario controls and execution architecture.

The Scenario Catalogue is added as a controlled reference and identification layer and does not replace or re-engineer the existing simulator execution path.
...
The Scenario Catalogue is a reference and V&V planning layer.

Adding or modifying a catalogue entry does not by itself constitute a change to the underlying simulator engine.
...
5. MARIN ENGINEERING ORIENTATION
...
The MARIN Innovation in Control JIP identifies, among other objectives:

- conceptual numerical design and evaluation;
- an extendable software framework for coupling external controllers;
- Software-In-the-Loop (SIL) evaluation;
- Hardware-In-the-Loop (HIL) evaluation;
- onshore and onboard prototype evaluation; and
- Key Performance Indicators (KPIs) for requirement specification and validation.

The JIP scope also describes a testbed intended to support controller development, optimisation and evaluation, determination of operational performance limits, safe FMECA work prior to onboard installation, and interfaces with industrial-standard modelling frameworks and communication protocols.

The Sextant Protocol™ catalogue therefore provides a research-level scenario and traceability framework that may be used as a starting point for discussion.

It does not claim equivalence to the MARIN methodology.
...
12. VERIFICATION AND VALIDATION DISTINCTION
...
- correct simulated execution behaviour; and
...
13. MARIN ENGINEERING ORIENTATION
...
16. CURRENT V&V RESEARCH STATUS
...
20. ENGINEERING REVIEW PRINCIPLE
...
On behalf of: DonDonna Trust Fund
